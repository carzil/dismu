...
import com.dismu.utils.AndroidPlatformUtils;
...
public class MainActivity extends Activity implements SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    static {
        com.dismu.utils.Utils.setPlatformUtils(new AndroidPlatformUtils());
    }
                    ...
                    public void run() {
                        ...
                        runOnUiThread(
                            new Runnable() {
                                @Override
                                public void run() {
                                  Toast.makeText(getApplicationContext(), "Restarted network", Toast.LENGTH_SHORT).show();
                                }
                            }
                        );
                    }
