...
public class LastFMAlbumArtSource implements AlbumArtSource {
    @Override
    public String getURL(Track track) {
        String baseURL = "http://www.lastfm.ru/music/";
        String pageURL = baseURL + URLEncoder.encode(track.getTrackArtist()) + "/" + URLEncoder.encode(track.getTrackAlbum());
        ...
        try {
            ...
            Pattern pat = Pattern.compile("<img src=\"(.*)\" class=\"album-cover\" itemprop=\"image\" />");
